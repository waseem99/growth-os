import type { PageDocumentInput } from "./schema";

const u = (n: number) => `00000000-0000-4000-8000-${String(n).padStart(12, "0")}`;

const skillupBlocks = (promotional: boolean): PageDocumentInput["blocks"] => [
...
export const skillupCleanReference: PageDocumentInput = { schemaVersion: 1, templateKey: "subscription-acquisition", stylePreset: "clean-light", blocks: skillupBlocks(false) };
export const skillupRanchersReference: PageDocumentInput = { schemaVersion: 1, templateKey: "subscription-acquisition", stylePreset: "campaign-dark", blocks: skillupBlocks(true) };

export const contentAcquisitionTemplate: PageDocumentInput = { schemaVersion: 1, templateKey: "content-acquisition", stylePreset: "campaign-dark", blocks: [
...
export const gameAcquisitionTemplate: PageDocumentInput = { schemaVersion: 1, templateKey: "game-acquisition", stylePreset: "premium-purple", blocks: [
