...
const base = { id, version: z.literal(1).default(1), visible: z.boolean().default(true) };
...
export const blockRegistry: Readonly<Record<BlockType, { schemaVersion: 1 }>> = Object.freeze(
  Object.fromEntries(BLOCK_TYPES.map((type) => [type, Object.freeze({ schemaVersion: 1 as const })])) as Record<BlockType, { schemaVersion: 1 }>
);
